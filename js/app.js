...
function showPage(id, skipRecord) {
  ...
  if (_ctaBtn) _ctaBtn.style.display = (id === 'compas' || id === 'dashboard' || id === 'cockpit' || id === 'lanzamientos') ? '' : 'none';
  ...
  if (id === 'cockpit')      renderCockpitPage();
